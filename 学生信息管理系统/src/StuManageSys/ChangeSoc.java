...
public class ChangeSoc  extends JFrame {
	...
	//-------------------------------------------------------------关闭界面
		...
		//============================================================构造方法
				public ChangeSoc() {
					...
					JLabel stubacjl1=new JLabel("修改成绩信息",JLabel.CENTER);
					...
					JComboBox<String>jc=new JComboBox<>(new MyComboBoxchc());
		...
		class MyComboBoxchc extends AbstractListModel<String> implements ComboBoxModel<String>{
