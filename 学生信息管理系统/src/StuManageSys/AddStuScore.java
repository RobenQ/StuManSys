...
import StuManageSys.AddStuScoreSure;
...
public class AddStuScore extends JFrame{
	/**
	 * 
	 */
	...
	public AddStuScore() {
		...
		JLabel stubacjl1=new JLabel("录入成绩信息",JLabel.CENTER);
		...
		JLabel stubacjl2_1=new JLabel("姓       名：",JLabel.CENTER);//标签提示字体设置
		JLabel stubacjl2_2=new JLabel("学       号：",JLabel.CENTER);
		JLabel stubacjl2_3=new JLabel("数      电：",JLabel.CENTER);
		JLabel stubacjl2_4=new JLabel("模      电：",JLabel.CENTER);
		JLabel stubacjl2_5=new JLabel("英       语：",JLabel.CENTER);
		JLabel stubacjl2_6=new JLabel("概 率 论  ：",JLabel.CENTER);
		JLabel stubacjl2_7=new JLabel("离散数学：",JLabel.CENTER);
		JLabel stubacjl2_8=new JLabel("大学体育：",JLabel.CENTER);
		JTextField stubacjt2_1=new JTextField();  //成绩信息录入框
		JTextField stubacjt2_2=new JTextField();
		JTextField stubacjt2_3=new JTextField();
		JTextField stubacjt2_4=new JTextField();
		JTextField stubacjt2_5=new JTextField();
		JTextField stubacjt2_6=new JTextField();
		JTextField stubacjt2_7=new JTextField();
		JTextField stubacjt2_8=new JTextField();
		...
		stubacjp2_4.add(stubacjt2_5);
		stubacjp2_5.add(stubacjt2_4);
		...
		class  stubacjp3jb1Action implements ActionListener{
			public void actionPerformed(ActionEvent e) {
				if (stubacjt2_1.getText().equals("")|stubacjt2_2.getText().equals("")|stubacjt2_3.getText().equals("")|
					...
					AddStuScoreSure sureLuRu=new AddStuScoreSure();
